...
public class Gerenciador {
	...
	public boolean addFuncionario(String nome, String senha, String sexo, String endereco, 
		...
		Funcionario f = new Funcionario(nome, senha, sexo, endereco, matricula, 
				salario, dataAdmissao, nascimento);
	...
	public boolean addEquipamento(int identificacao, Date aquisicao, String descricao, double custoDiario, 
		...
		boolean guardou = false;
		Equipamento e = new Equipamento(identificacao, aquisicao, descricao, custoDiario, 
				manutencao, tipo);
	...
	public void addEmprestimo(LocalDate dataInicial, LocalDate dataFinal, String identificacao,
			Equipamento equipamento, Funcionario funcionario){
		
		Emprestimo em = new Emprestimo(dataInicial, dataFinal, identificacao,
